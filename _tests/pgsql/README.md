...
并保证 `_helpers.py` 中 `TEST_DB_CONFIG` 指向的 PostgreSQL 库可用。
...
python _tests/pgsql/test_insert.py
python _tests/pgsql/test_select.py
python _tests/pgsql/test_update.py
python _tests/pgsql/test_delete.py
python _tests/pgsql/test_exec.py
